...
For the purpose of standardising quality control procedures within the pipeline, the nPYc-Toolbox defines a set of reference sample types and design elements, which will first be introduced. 
